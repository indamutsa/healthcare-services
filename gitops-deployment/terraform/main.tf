terraform {
  ...
  backend "s3" {
    bucket = "clinical-mlops-terraform-state"
    key    = "infrastructure/terraform.tfstate"
    region = "us-west-2"
    encrypt = true
    dynamodb_table = "clinical-mlops-terraform-locks"
  }
}
...
resource "aws_elasticache_replication_group" "redis" {
  ...
  description                = "Redis cluster for clinical mlops"
...
resource "aws_s3_bucket" "ml_artifacts" {
  bucket = "${var.project_name}-ml-artifacts-${random_string.suffix.result}"
