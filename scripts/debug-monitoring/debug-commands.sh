...
# Comprehensive debugging and troubleshooting utilities for Clinical Trials Service
#
...
# Level 3: Network and connectivity
...
run_debug_commands() {
    ...
    for level in "${debug_levels[@]}"; do
        ...
        # Add separator between levels (except the last one)
